...
import lab.dragon.power.handler.tcp.DeviceUpgradeHandler;
...
public class FirmwareUpgradeWebSocketBak {
    // WebSocket发送数据队列，用于缓存发送给客户端的消息
    public static final LinkedBlockingQueue<String> SEND_MESSAGE_QUEUE = new LinkedBlockingQueue<>();
    private static final Logger log = LoggerFactory.getLogger(FirmwareUpgradeWebSocketBak.class);
